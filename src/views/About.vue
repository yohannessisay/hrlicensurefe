    ...
    <div class="frosted-glass m-4">
      ...
      <div class="grid grids-cols-1">
        ...
        <h4 class="p-4 font-DosisBold text-2xl  text-primary-700 ">
          ...
          panel of experts. If the application is approved, the medical
          professional will be issued a license. Licenses are valid for five
        ...
        <ul>
          <li class="ml-8 font-DosisBold text-2xl  text-primary-700 ">
            It is easy to use. The system is designed to be user-friendly and
            can be accessed by anyone with an internet connection.
          </li>
          <li class="ml-8 font-DosisBold text-2xl  text-primary-700 ">
            It is efficient. The system allows medical professionals to apply
            for a license or renew their license quickly and easily.
          </li>
          <li class="ml-8 font-DosisBold text-2xl  text-primary-700 ">
            It is secure. The system uses the latest security measures to
            protect the personal information of medical professionals.
          </li>
          <li class="ml-8 font-DosisBold text-2xl  text-primary-700 ">
            It is convenient. Medical professionals can apply for a license or
            renew their license from anywhere in the world.
          </li>
        </ul>

        <h4 class="p-4 font-DosisBold text-2xl "></h4>
      </div>
    </div>
    <div class="flex justify-center">
      <h2
...
.frosted-glass {
  ...
  padding: 50px;
  border-radius: 10px;
  box-shadow: 0 5px 50px rgba(0, 0, 0, 0.63);
}
svg {
  height: 188px;
}
