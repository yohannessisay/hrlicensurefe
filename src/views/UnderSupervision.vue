        ...
        >
          <div class="flex " v-for="i in this.newlicense.length" v-bind:key="i">
            ...
            >
              ...
              >
                <div
                  class="flex justify-center items-center  ml-8 mr-8 pb-16 box-shadow-pop rounded-lg bg-lightGrey-100"
                >
                  <div class="p-4 w-48 h-64">
                    <span
                      class="text-lightBlueB-500 mt-tiny flex justify-start content-center"
        ...
        >
          <div class="flex " v-for="i in this.renewal.length" v-bind:key="i">
            ...
            >
              ...
              >
                <div
                  class="flex justify-center items-center  ml-8 mr-8 pb-20 box-shadow-pop rounded-lg bg-lightGrey-100"
                >
                  <div class="p-4 w-48 h-64">
                    <span
                      class="text-lightBlueB-500 mt-tiny flex justify-start content-center"
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div
                  class="flex justify-center items-center pb-16 ml-8 mr-8 box-shadow-pop rounded-lg bg-lightGrey-100"
                >
                  <div class="p-4 w-48 h-64">
                    <span
                      class="text-lightBlueB-500 mt-tiny flex justify-start content-center"
