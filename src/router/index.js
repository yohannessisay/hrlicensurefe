...
const routes = [{
    ...
    },
    {
        ...
        name: "NewProfile",
        component: () =>
            import ("../components/Profile/NewProfile.vue"),
    },
    {
        path: "/signup",
        name: "Signup",
    ...
    },
    {
        ...
        component: () =>
            import ("../views/LicenseRequests.vue"),
    },
    {
        name: "Google-Form",
        path: "/google-form",
    ...
    },
    {
        ...
        name: "Approved",
        component: () =>
            import ("../views/Approved.vue"),
    },
    {
        path: "/submitted",
        name: "Submitted",
        component: () =>
            import ("../views/Submitted.vue"),
    },
    {
        path: "/inReview",
        name: "InReview",
        component: () =>
            import ("../views/InReview.vue"),
    },
    {
        path: "/undersupervision",
        name: "UnderSupervision",
        component: () =>
            import ("../views/UnderSupervision.vue"),
    },
    {
        path: "/declined",
        name: "Declined",
        component: () =>
            import ("../views/Declined.vue"),
    },
    {
        path: "/withdrawn",
        name: "Withdraw",
    ...
    },
    {
        ...
        name: "PendingPayment",
        component: () =>
            import ("../views/PendingPayment.vue"),
    },
    {
        path: "/approvedPayment",
        name: "ApprovedPayment",
        component: () =>
            import ("../views/ApprovedPayment.vue"),
    },
    {
        path: "/declinedPayment",
        name: "DeclinedPayment",
        component: () =>
            import ("../views/DeclinedPayment.vue"),
    },
    {
        path: "/draft",
        name: "Draft",
    ...
    },
    {
        ...
        name: "NewLicense",
        component: () =>
            import ("../components/NewLicense/NewLicense.vue"),
    },

    {
        ...
        name: "Renewal",
        component: () =>
            import ("../components/Renewal/Renewal.vue"),
    },
    {
        path: "/verification",
        name: "Verification",
    ...
    },
    {
        ...
        name: "GoodStanding",
        component: () =>
            import ("../components/GoodStanding/GoodStanding.vue"),
    },
    // {
    //   path: "/admin/review",
    //   name: "ReviewerHome",
    ...
    // },
    {
        ...
        name: "ReviewerHome",
        component: () =>
            import ("../components/Reviewer/ReviewerMenu.vue"),
    },
    {
    ...
    },
    {
        ...
        name: "dashboard",
        component: () =>
            import ("../components/Reviewer/Dashboard.vue"),
    },
    {
        path: "/myWork",
        name: "myWork",
        component: () =>
            import ("../components/Reviewer/MyWork.vue"),
    },
    {
        path: "/allWork",
        name: "allWork",
        component: () =>
            import ("../components/Reviewer/AllWork.vue"),
    },
    {
        path: "/admin/unfinished",
        name: "unfinished",
        component: () =>
            import ("../components/Reviewer/Unfinished.vue"),
    },
    {
        path: "/admin/unfinishedAll",
        name: "allUnfinished",
        component: () =>
            import ("../components/Reviewer/AllUnfinished.vue"),
    },
    {
        path: "/admin/unconfirmed",
        name: "unconfirmed",
        component: () =>
            import ("../components/Reviewer/Unconfirmed.vue"),
    },
    {
        path: "/admin/onreview",
        name: "onreview",
        component: () =>
            import ("../components/Reviewer/OnReview.vue"),
    },
    {
        path: "/admin/evaluateReview",
        name: "evaluateReview",
        component: () =>
            import ("../components/Reviewer/EvaluateReview.vue"),
    },
    {
        path: "/admin/assignedToYou",
        name: "assignedToYou",
        component: () =>
            import ("../components/Reviewer/AssignedToYou.vue"),
    },
    {
        path: "/admin/assignedToAll",
        name: "assignedToAll",
        component: () =>
            import ("../components/Reviewer/AllAssigned.vue"),
    },
    {
        path: "/admin/unassigned",
        name: "unassigned",
        component: () =>
            import ("../components/Reviewer/Unassigned.vue"),
    },
    {
        path: "/admin/allCertifiedUsers",
        name: "allCertifiedUsers",
        component: () =>
            import ("../components/Reviewer/AllCertifiedUsers.vue"),
    },
    {
    ...
    },
    {
        ...
        name: "certifiedusers",
        component: () =>
            import ("../components/Reviewer/CertifiedUsers.vue"),
    },
    {
    ...
    },
    {
        ...
        component: () =>
            import ("../components/Reviewer/PendingPayments.vue"),
    },
    {
        path: "/admin/allPendingPayments",
        name: "allPendingPayments",
        component: () =>
            import ("../components/Reviewer/AllPendingPayments.vue"),
    },
    {
    ...
    },
    {
        ...
        name: "evaluate",
        component: () =>
            import ("../components/Reviewer/Evaluate.vue"),
    },
    {
        path: "/admin/evaluatePayment/:applicationType/:applicationId",
        name: "evaluatePayment",
        component: () =>
            import ("../components/Reviewer/EvaluatePayment.vue"),
    },
    {
        path: "/admin/detail/:applicationType/:applicationId/:applicantId",
        name: "detail",
        component: () =>
            import ("../components/Reviewer/Detail/LicenseDetail.vue"),
    },
    {
    ...
    {
        path: "/admin/returnedToMeDetail/:applicationType/:applicationId/:applicantId",
        name: "returnedToMeDetail",
        component: () =>
            import ("../components/Reviewer/Detail/ReturnedToMeDetail.vue"),
    },
    {
        path: "/admin/pending-payment-evaluation/:applicationType/:applicationId/:applicantId",
    ...
    {
        path: "/admin/on-review-detail/:applicationType/:applicationId/:applicantId",
        name: "onReviewDetail",
        component: () =>
            import ("../components/Reviewer/Detail/OnReviewDetail.vue"),
    },
    {
        path: "/admin/returned-application-detail/:applicationType/:applicationId/:applicantId",
        name: "returnedApplicationDetail",
        component: () =>
            import ("../components/Reviewer/Detail/ReturnedApplicationDetail.vue"),
    },
    {
        path: "/admin/others-re-evaluate-detail/:applicationType/:applicationId/:applicantId",
        name: "othersReEvaluateDetail",
        component: () =>
            import ("../components/Reviewer/Detail/OthersReEvaluateDetail.vue"),
    },
    {
        path: "/admin/newlicense-document/:newLicenseApplicationId/:newLicenseApplicantId/:renewalApplicationId/:renewalApplicantId",
    ...
    },
    {
        ...
        name: "Admin",
        component: () =>
            import ("../components/Landing/AdminLanding.vue"),
    },
    {
        path: "/admin/create",
        name: "CreateAdmin",
        component: () =>
            import ("../components/Reviewer/CreateAdmin.vue"),
    },
    {
