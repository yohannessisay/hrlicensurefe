    ...
    <main-content>
        ...
        <div class="container my-12 mx-auto px-4 md:px-12" v-if="noData == false">
            <div class="flex flex-wrap sm:-mx-1 lg:-mx-4">
                <div v-for="suspendedLicense in suspendedLicenses" :key="suspendedLicense.id" class="
              bg-white
              my-1
              px-1
              md:w-1/4
            ...
            ">
                    ...
                    <div>
                        <h2 class="text-main-400 border-b-2 text-xl p-2">
                            ...
                            suspendedLicense.newLicenseCode
                            ? suspendedLicense.newLicenseCode
                            : "-"
                            }}</span>
                        </h2>
                        ...
                        <div class="border-b-2 text-main-400">
                            <div class="grid grid-rows-2 p-2 mb-2 border-b-2">
                                ...
                                <ul class="text-black text-sm">
                                    <li v-for="(education, index) in suspendedLicense.educations" :key="education.id"
                                        ...
                                        <span class="text-black text-sm">
                                            ...
                                            <span v-if="index != suspendedLicense.educations.length - 1">
                                                ,
                                            </span>
                                        </span>
                                    </li>
                  ...
                  ">
                                ...
                                <p class="text-black text-sm">
                                    {{
                                    suspendedLicense.certifiedDate
                                    ? suspendedLicense.certifiedDate.slice(0, 10)
                                    : "Waiting for review"
                                    }}
                                </p>
                            </div>
                  ...
                  ">
                                ...
                                <p class="text-black text-sm">
                                    {{
                                    suspendedLicense.licenseExpirationDate
                                    ? suspendedLicense.licenseExpirationDate.slice(0, 10)
                                    : "Waiting for review"
                                    }}
                                </p>
                            </div>
                  ...
                  " href="#">
                            ...
                            suspendedLicense.createdAt.slice(0, 10)
                            }}</span>
                        </footer>
                    ...
                    duration-150
                    ease-in-out
                  " @click="openSuspendedDetail(suspendedLicense.id)" data-bs-toggle="modal"
                                data-bs-target="#suspendedDetail">
                                View Detail
                            </button>
                        </div>
                    </div>
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            store.dispatch("newlicense/getNewLicenseByUser", userId).then((res) => {
                ...
                if (results.length > 0) {
                    suspendedLicenses.value = results.filter((suspendedLicense) => {
                        return suspendedLicense.applicationStatus.code === "SUSP";
                    });

                    if (suspendedLicenses.value.length === 0) {
                        noData.value = true;
                    }
