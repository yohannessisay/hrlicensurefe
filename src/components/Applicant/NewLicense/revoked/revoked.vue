 ...
 <main-content :url="'newLicense'">
    ...
    <div class="container my-12 mx-auto px-4 md:px-12" v-if="noData == false">
      <div class="flex flex-wrap sm:-mx-1 lg:-mx-4">
        <div
          v-for="revokedLicense in revokedLicenses"
          :key="revokedLicense.id"
          class="
            bg-white
            my-1
            px-1
            ...
            <div class="border-b-2 text-main-400">
              <div class="grid grid-rows-2 p-2 mb-2 border-b-2">
                ...
                <ul class="text-black text-sm">
                  <li
                    v-for="(education, index) in revokedLicense.educations"
                    :key="education.id"
                  ...
                  >
                    <span class="text-black text-sm">
                      ...
                      <span
                        v-if="index != revokedLicense.educations.length - 1"
                      >
                        ,
                      </span>
                    </span>
            ...
            <div class="flex justify-center">
              <button
                class="
                  ...
                  ease-in-out
                "
                @click="openRevokedDetail(revokedLicense.id)"
