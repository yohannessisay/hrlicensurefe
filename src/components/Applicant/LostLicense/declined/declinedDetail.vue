                    ...
                    <div class="my-1 px-1 w-1/2 md:w-1/2 lg:my-4 lg:px-4 lg:w-8/12">
                      ...
                      <article class="overflow-hidden rounded-lg">
                        ...
                        <div class="grid grid-flow-row auto-rows-max">
                          <div class="flex justify-between px-4 py-1">
                            <div class="text-main-400 font-bold">
                              <p class="text-grey-800 text-base mb-4">
                                {{
...
export default {
  ...
  setup(props) {
    ...
    watch(props.modalDataId, () => {
      ...
      store
        .dispatch("lostLicenses/getLostLicenseById", props.modalDataId.id)
        .then((res) => {
    ...
    const reApply = () => {
      ...
      isLoading.value = true;
      store.dispatch("lostLicenses/updateDeclined", license).then(() => {
        ...
        store
          ...
          .then(() => {
            ...
            router.push({ path: "/Applicant/LostLicenses/submitted" });
            location.reload();
          })
          .catch(() => {
