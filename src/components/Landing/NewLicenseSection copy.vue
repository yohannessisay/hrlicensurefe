<template>
  ...
  <div
    class="w-full blue-gradient flex justify-center items-center py-xl box-border"
  >
    <section
      class="content-wrapper-new-license w-full bg-primary-400 flex flex-col md:flex-row justify-center md:justify-start items-center"
    >
      ...
      <section
        class="flex flex-col -ml-large sm:ml-large items-center md:items-start"
      >
        ...
        <h3 class="mt-small text-primary-100 text-center -ml-large">
