...
>
	    ...
	    <linearGradient
            ...
            >
              ...
              <stop offset="1" stop-color="#3674b9" />
            	...
            	<linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="59.9541" y1="328.8946" x2="677" y2="328.8946">
		<stop  offset="0" style="stop-color:#A8B1A1"/>
		<stop  offset="1" style="stop-color:#5073B1"/>
	</linearGradient>
	<path class="st0" d="M283.7,110.2l3,0.2l12.7-2.5l7.6-4.4l1.1-1.7h2.1l2.5,2l1,1.9l1.6,2.5l3,0.4l7.2-1.7l3.6-1.1l3,0.9l3.8,0.7
	...
	<path class="st1" d="M304.2,218.6c-68.1,0-123.6,55.3-123.6,123.5S236,465.6,304.2,465.6S427.7,410.3,427.7,342
      ...
      <transition name="slide-fade-to-top">
        ...
        >
          ...
          <h5 class="mt-small text-primary-100 text-center block relative">
           <div>Diploma graduates should pass  level 4 COC exam before applying.
If you are a degree graduate and your profession is under licensure examination, you should pass the exam to be able to apply. </div>
<div>
If your profession type is not under the licensure exam please have your university send your graduation list to the ministry of health through this email nhpled.moh@gmail.com.
</div>
