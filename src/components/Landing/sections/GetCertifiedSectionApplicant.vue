<template>
  <section class="wrapper mt-24 sm:mt-0">
    <div
    ...
    >
      <LandingIllustration class="block lg:absolute z-0 -mb-small sm:-mb-large" />
      <div
      ...
      >
        <transition name="slide-fade-to-left">
          <section v-if="showContent" class="flex flex-col items-center lg:items-end">
            <h1 class="text-3xl sm:text-largeDisplay -mb-tiny sm:-mb-small text-main-400">
              Get Certified
            </h1>
          </section>
        </transition>
