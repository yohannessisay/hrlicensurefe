    ...
    >
      <transition name="slide-fade-to-right">
        ...
        >
         ...
         <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="108.9599" y1="337.246" x2="575.622" y2="337.246">
		<stop  offset="0" style="stop-color:#A8B1A1"/>
		<stop  offset="1" style="stop-color:#5073B1"/>
	</linearGradient>
	<path class="st0" d="M574.3,313.5c-0.8-7.2-1.8-14.5-3.2-21.7c-0.7-3.3-3.9-5.4-7.1-4.8c-3.3,0.7-5.4,3.9-4.8,7.1
		...
		<linearGradient id="SVGID_00000047782681910066937670000006148370083747561640_" gradientUnits="userSpaceOnUse" x1="416.783" y1="181.865" x2="623.053" y2="181.865">
		<stop  offset="0" style="stop-color:#A8B1A1"/>
		<stop  offset="1" style="stop-color:#5073B1"/>
	</linearGradient>
	<path style="fill:url(#SVGID_00000047782681910066937670000006148370083747561640_);" d="M520,78.7c-56.9,0-103.2,46.2-103.2,103.1
		...
		<linearGradient id="SVGID_00000118396780671797878760000017281893121410540986_" gradientUnits="userSpaceOnUse" x1="101.233" y1="504.548" x2="307.503" y2="504.548">
		<stop  offset="0" style="stop-color:#A8B1A1"/>
		<stop  offset="1" style="stop-color:#5073B1"/>
	</linearGradient>
	<path style="fill:url(#SVGID_00000118396780671797878760000017281893121410540986_);" d="M204.4,401.4
      ...
      <transition name="slide-fade-to-top">
        ...
        >
          ...
          <h5 class="mt-small text-primary-100 text-center">
            All foreigner applicants must authenticate their educational document and professional license. 
Applicants must have at least two years of work experience when applying and applicants must have a valid passport in order to apply 
...
.st0{fill:url(#SVGID_1_);}
	.st1{fill:url(#SVGID_00000122691386389552051400000009324463607062572468_);}
	.st2{fill:url(#SVGID_00000001642809056259780800000013184893846374717603_);}
