      ...
      <form action="/">
        ...
        <div class="item">
           <div class="left">
                ...
                <div class="">
                    <input v-model ="personalInfo.firstName" type="text" name="name" placeholder="First" />
                </div>
           </div> 
           <div class="right">
                <p class="">Nationality</p>
                <div class="">
                    <input v-model ="personalInfo.nationality" type="text" name="name" placeholder="Nationality" />
                </div>
            </div>   
        </div>
