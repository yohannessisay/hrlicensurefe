            ...
            <div class="py-8">
              <div>
                <h2 class="text-2xl font-semibold leading-tight">
                  Draft Applications Assigned To You
                </h2>
              </div>
        ...
        <template v-slot:to_others>
          <div class="container mx-auto px-4 sm:px-8">
            <div class="py-8">
              <div>
                <h2 class="text-2xl font-semibold leading-tight">
                  Draft Applications Assigned To Others
                </h2>
              </div>
              <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                <div class="p-4 bg-grey-200 mb-4 rounded-lg">
...
export default {
  ...
  setup() {
    ...
    const draftAssignedToYou = (apiParameters) => {
      let statId = statuses
    ...
    const draftAssignedToOthers = (apiParameters) => {
      let statId = statuses
        ? statuses.filter((stat) => stat.code == "REVDRA")[0].id
        : "";
