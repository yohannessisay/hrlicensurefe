        ...
        <template v-slot:to_others>
          <div class="container mx-auto px-4 sm:px-8">
            <div class="py-8">
              <div>
                <h2 class="text-2xl font-semibold leading-tight">
                  Applications Returned By Others
                </h2>
              </div>
              <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                <div class="p-4 bg-grey-200 mb-4 rounded-lg">
...
import NewLicenseMainContent from "../../../SharedComponents/returned.vue";
...
export default {
  ...
  setup() {
    ...
    const returnedByYou = (apiParameters) => {
      let statId = statuses
        ? statuses.filter((stat) => stat.code == "RTN")[0].id
        : "";
        toYouTableData=[];
      store
    ...
    const returnedByOthers = (apiParameters) => {
      let statId = statuses
        ? statuses.filter((stat) => stat.code == "RTN")[0].id
        : "";
        tableData=[];
