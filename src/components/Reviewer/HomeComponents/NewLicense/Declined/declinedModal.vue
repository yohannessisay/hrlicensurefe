                    ...
                    <div class="flex flex-wrap">
                      ...
                      >
                        <div class="flex items-start">
                          ...
                          <div class="grow ml-6">
                            <h2 class="font-bold mb-1">Decline Detail</h2>
                            <div class="border-2 p-2 rounded-lg m-1 text-primary-500">
                              <p class="text-gray-500">
                    ...
                    >
                      <div class="flex items-start m-2">
                        ...
                        <div class="grow ml-6 mb-4">
                          <h2 class="font-bold mb-1 text-grey-800">Education Detail</h2>
...
export default {
  ...
  setup(props) {
    ...
    const release = () => {
      ...
      newLicense.acceptedFields = [];

      newLicense.documents.forEach((element) => {
