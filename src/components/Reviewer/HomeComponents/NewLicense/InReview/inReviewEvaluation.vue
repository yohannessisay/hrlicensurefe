  ...
  <section class="home-section">
    ...
    <reviewer-nav-bar>
      <h2 class="text-2xl">
        ...
        {{
          newLicense && newLicense.is_license_delegation ? "( License Designation )" : ""
        }}
      </h2>
    </reviewer-nav-bar>
    <!-- Header -->
    ...
    <div class="home-content">
      <div class="mt-4 vld-parent">
        ...
        <div class="container px-4 mx-auto mb-12 sm:px-4">
          ...
          >
            <h2 class="ml-4 text-2xl text-white">
              Evaluating
              {{
            ...
            <div class="w-full">
              <div class="box-shadow-pop bg-lightGrey-100">
                <div class="grid grid-cols-1 sm:grid-cols-8">
                  <div
                    class="sm:col-span-2 col-span-8 container w-64 h-40 p-4 mt-8 ml-8 rounded-lg shadow-md"
                  >
                    <!-- Accepted Documents -->
                    <div class="mt-8">
                              ...
                              <article class="overflow-hidden rounded-lg w-full">
                                ...
                                >
                                  ...
                                  <div v-if="editPersonalData">
                                    <input
                                      v-model="
                                        newLicense.profile.alternativeGrandFatherName
                                      "
                                      class="w-48"
                                      type="text"
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        ...
                        v-for="education in newLicense && newLicense.educations
                          ? newLicense.educations
                          : []"
                        :key="education.id"
                      >
                        <div class="grid grid-cols-3">
