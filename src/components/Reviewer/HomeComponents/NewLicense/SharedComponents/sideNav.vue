<template>
  <div class="sidebar">
    ...
    <ul class="nav-links">
      ...
      <router-link to="/admin/newLicense/inReview">
        <li
          :class="
            $route.fullPath === '/admin/newLicense/inReview'
              ? 'mb-2 active'
              : ''
          "
        >
      ...
      <router-link to="/admin/newLicense/draft">
        <li
          :class="
      ...
      <router-link to="/admin/newLicense/approved">
        <li
          :class="
            $route.fullPath === '/admin/newLicense/approved'
              ? 'mb-2 active'
              : ''
          "
        >
      ...
      <router-link to="/admin/newLicense/declined">
        <li
          :class="
            $route.fullPath === '/admin/newLicense/declined'
              ? 'mb-2 active'
              : ''
          "
        >
      ...
      <router-link to="/admin/newLicense/underSupervision">
        <li
          :class="
            $route.fullPath === '/admin/newLicense/underSupervision'
              ? 'mb-2 active'
              : ''
          "
        >
      ...
      <router-link to="/admin/newLicense/licensed">
        <li
          :class="
            $route.fullPath === '/admin/newLicense/licensed'
              ? 'mb-2 active'
              : ''
          "
        >
