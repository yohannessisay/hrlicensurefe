<template>
  ...
  <section class="home-section">
    <!-- Header -->
    <reviewer-nav-bar>
      <h2 class="dashboard">Assigned</h2>
    </reviewer-nav-bar>
    <!-- Header -->
...
import NewLicenseMainContent from "../../ApplicationTypes/Renewal/MainComponents/assigned.vue";
import { ref, onMounted } from "vue";
import { useStore } from "vuex";

import applicationStatus from "../../Configurations/getApplicationStatus.js";
import VueTableLite from "vue3-table-lite";
import editModal from "./Modals/assignedModal.vue";
  ...
  setup() {
    ...
    const asssignedToOthers = () => {
      ...
      applicationStatus(store, "IRV").then((res) => {
        ...
        store
          .dispatch("reviewerRenewal/getRenewalOthersAssigned", adminStatus)
          .then(() => {
            loading.value = false;

            allInfo.value.assignApplication =
              store.getters[
                "reviewerRenewal/getRenewalAssignedToOthersSearched"
              ];
    ...
    const assignedToYou = () => {
      ...
      applicationStatus(store, "IRV").then((res) => {
        ...
        store
          .dispatch("reviewerRenewal/getRenewalAssigned", adminStatus)
          .then(() => {
            loading.value = false;
