<template>
  ...
  <section class="home-section">
    <!-- Header -->
    <reviewer-nav-bar>
      <h2 class="dashboard">Unassigned</h2>
    </reviewer-nav-bar>
    <!-- Header -->
...
import RenewalMainContent from "../../ApplicationTypes/Renewal/MainComponents/unassigned.vue";
import { ref, onMounted } from "vue";
import { useStore } from "vuex";
import applicationStatus from "../../Configurations/getApplicationStatus.js";
import VueTableLite from "vue3-table-lite";
import editModal from "./Modals/unassignedModal.vue";
