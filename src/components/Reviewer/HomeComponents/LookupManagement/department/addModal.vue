...
export default {
  ...
  setup() {
    ...
    const enableSaveButton = () => {
      if (departmentName.value.length > 3) {
    ...
    const saveDepartment = () => {
      ...
      saveData.value = {
        name: departmentName.value ? departmentName.value : "",
        code: departmentName.value
          ? "DP_" + departmentName.value.slice(0, 4).toUpperCase() + "_" + today
          : "",
      };

      store.dispatch("lookups/addDepartment", saveData.value).then((res) => {
