<template>
  ...
  <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
    id="viewDetail" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="viewDetailLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl relative w-auto pointer-events-none">
      <div
        ...
        <div class="vld-parent">
          <loading :active="isLoading" :is-full-page="false" :color="'#2F639D'" :opacity="0.7"></loading>
          <div class="modal-body relative p-4">
            ...
            <div class="container px-6 mx-auto">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
                <div
                  ...
                  <div class="m-3 text-center">
                    ...
                    <h2 class="font-light font-mono transition-all duration-200 text-white text-3xl" id="totalNew">
                ...
                <div
                  ...
                  <div class="m-3 text-center">
                    ...
                    <h2 class="font-light font-mono transition-all duration-200 text-white text-3xl" id="totalRen">
                      <span style="font-size: 38px !important">
                        {{
                ...
                <div
                  ...
                  <div class="m-3 text-center">
                    ...
                    <h2 class="font-light font-mono transition-all duration-200 text-white text-3xl" id="totalGoo">
                      <span style="font-size: 38px !important">
                        {{
              ...
              <div class="container p-2x shadow-md bg-white m-4">
                <apexchart type="bar" height="530" :options="statusChartOptions" :series="statusSeries"></apexchart>
              </div>
            </div>
          </div>
        </div>
