  ...
  <section class="home-section">
    ...
    <reviewer-nav-bar>
      <ol class="list-reset flex">
        ...
        <li>
          <a href="#" class="pointer-events-none text-lg text-grey-300">Individual Report</a>
        </li>
      </ol>
    </reviewer-nav-bar>
    <!-- Header -->
      ...
      <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
          <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 overflow-x-auto">
            <div class="grid grid-rows-1">
              <div class="grid grid-cols-3">
                <div class="col-span-1 mt-5">
                  <div class="input-group relative flex flex-wrap items-stretch w-full mb-4 mt-1">
                    <input type="text"
                      ...
                      placeholder="Search" aria-label="Search" v-model="searchTerm" aria-describedby="button-addon2"
                      @keyup.enter="searchUser()" />

                    <button data-te-toggle="tooltip" title="Search user"
            ...
            <div class="inline-block min-w-full shadow-md rounded-lg overflow-hidden bg-primary-800">
              <vue-table-lite :is-loading="userTable.isLoading" :columns="userTable.columns" :rows="userTable.rows"
                :total="userTable.totalRecordCount" :sortable="userTable.sortable" @is-finished="tableLoadingFinish"
                @row-clicked="rowClicked" @do-search="doSearch"></vue-table-lite>
            </div>
          </div>
        </div>
      </div>
