  ...
  <nav>
    ...
    <div class="profile-details">
      <span
        ...
        ><i class="text-2xl fa fa-bell text-primary-600 "></i
      ></span>
      ...
      <div class="flex flex-row">
        ...
        >
          ...
          <span v-if="notifications && notifications.length > 0">
            <li
              class="border-b-4 cursor-pointer text-primary-600 hover:underline"
        ...
        <div class="relative inline-block text-left ">
          <a
            class="flex items-center justify-center ml-4 rounded-full focus:outline-none bg-primary-700 text-lightBlueB-400 hover:text-gray-800 w-7 h-7"
            id="options-menu"
            aria-expanded="true"
            aria-haspopup="true"
            href="#"
          ...
          >
            <svg
              ...
              stroke="currentColor"
              fill="none"
              class="w-8 h-8 px-1 py-1 font-bold text-white"
              aria-hidden="true"
            >
          ...
          >
            <div class="px-1 py-1 " role="none">
              <a
                href="/admin/profile"
                class="block px-4 py-2 mb-2 text-sm font-bold text-white border-b-4 hover:bg-white hover:text-primary-600"
                role="menuitem"
                id="logout"
              >
              ...
              <a
                @click="logout"
                class="block px-4 py-2 text-sm font-bold text-white hover:bg-white hover:text-primary-600"
                role="menuitem"
                id="logout"
              >
