  ...
  <div>
    ...
    <div class="bg-lightBlueB-200 h-full" v-if="!allInfo.searchByInput">
      ...
      <div class="flex pl-12 pt-tiny" v-if="expertLevel === 3">
        <Title message="All New License Approved" />
      </div>
      <div class="flex pl-12 pt-tiny" v-else>
        <Title message="All New License Approved (Not Yet Confirmed)" />
      </div>
...
export default {
  ...
  setup() {
    ...
    const fetchNewLicenseUnconfirmed = () => {
      ...
      store
        .dispatch("reviewerNewLicense/getNewLicenseAllApproved", adminId)
        .then((res) => {
