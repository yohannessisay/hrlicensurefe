...
<reviewer-side-bar>
    <ul class="nav-links">
        ...
        <router-link to="/admin/userManagement" v-if="
          adminData
        ...
        <router-link to="/admin/importResults" v-if="adminData ? adminData.role.code != 'SA' : ''">
            <li class="mb-2">
        ...
        <router-link to="/admin/lookupManagement" v-if="
          adminData
        ...
        <router-link to="/admin/lookupManagement/regional/licenseExpirationDate" v-if="
          adminData
